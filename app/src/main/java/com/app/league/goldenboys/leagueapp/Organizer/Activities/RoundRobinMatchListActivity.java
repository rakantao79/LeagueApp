...
public class RoundRobinMatchListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_round_robin_match_list);
        ...
        mRecyclerview = findViewById(R.id.recyclerView_RoundRobinMatchList);
        linearLayoutManager = new LinearLayoutManager(this);

        mDatabaseRef = FirebaseDatabase.getInstance().getReference().child("LeagueEntries").child(leagueTitle).child(divisionCategory).child("RoundRobinMatchList");
            ...
            protected void populateViewHolder(MatchListViewholder viewHolder, DataMatchList model, int position) {
                ...
                viewHolder.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent intent = new Intent(RoundRobinMatchListActivity.this, RoundRobinMatchDetailActivity.class);
