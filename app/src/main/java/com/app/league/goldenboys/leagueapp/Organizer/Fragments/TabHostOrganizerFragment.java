 ...
 */
public class TabHostOrganizerFragment extends Fragment {


    public TabHostOrganizerFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_tab_host_organizer, container, false);

        ViewPager viewPager = view.findViewById(R.id.viewpager_organizer);
        setupViewPager(viewPager);

        TabLayout tabs = view.findViewById(R.id.tab_organizer);
