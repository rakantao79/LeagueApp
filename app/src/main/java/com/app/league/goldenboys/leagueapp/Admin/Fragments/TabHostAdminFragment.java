 ...
 */
public class TabHostAdminFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_tab_host_admin, container, false);

        ViewPager viewPager = view.findViewById(R.id.viewpager_admin);
        setupViewPager(viewPager);

        TabLayout tabs = view.findViewById(R.id.tab_admin);
